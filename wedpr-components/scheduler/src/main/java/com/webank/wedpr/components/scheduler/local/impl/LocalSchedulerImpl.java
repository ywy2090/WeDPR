...
package com.webank.wedpr.components.scheduler.local.impl;
...
import com.webank.wedpr.components.scheduler.local.orchestrate.JobOrchestrate;
...
public class LocalSchedulerImpl implements Scheduler {
    private static final Logger logger = LoggerFactory.getLogger(LocalSchedulerImpl.class);
    private final ProjectMapperWrapper projectMapperWrapper;
    private final String agency;
    private final ThreadPoolService threadPoolService;
    private final JobOrchestrate jobOrchestrate;

    public LocalSchedulerImpl(
            String agency,
        ...
        this.jobOrchestrate =
                new JobOrchestrate(
                        executorManager, projectMapperWrapper, jobChecker, fileMetaBuilder);
